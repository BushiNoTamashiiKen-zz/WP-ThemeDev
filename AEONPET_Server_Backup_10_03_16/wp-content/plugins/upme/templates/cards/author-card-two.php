...
//    echo "<pre>";print_r($profile_url);exit;
?>

<div class="upme-wrap">
    <div class="upme-author-design-two upme-author-design" style="background:<?php echo $background_color; ?>;color:<?php echo $font_color; ?>" >

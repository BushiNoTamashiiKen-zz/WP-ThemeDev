...
<div class="upme-wrap">
    ...
    <div class="upme-slider-design-two  upme-team-design-two upme-team-design" style="background:<?php echo $background_color; ?>;color:<?php echo $font_color; ?>">
        
        <div class="flexslider flexslider-two">
            <ul class="slides">            

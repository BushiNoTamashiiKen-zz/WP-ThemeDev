 ...
 */
class upme_FacebookApiException extends Exception
{
  /**
 ...
 * @author Naitik Shah <naitik@facebook.com>
 */
abstract class upme_BaseFacebook
{
  /**
   * Version.
   */
  ...
  public function setExtendedAccessToken() {
    ...
    catch (upme_FacebookApiException $e) {
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if ($result === false) {
      $e = new upme_FacebookApiException(array(
  ...
  protected function throwAPIException($result) {
    $e = new upme_FacebookApiException($result);
    switch ($e->getType()) {
      // OAuth 2.0 Draft 00 style
      case 'OAuthException':
        // OAuth 2.0 Draft 10 style

				...
				<div class="users-posts-wrap"><?php
					...
					<form id="blt_posts_form" action="<?php echo blt_get_option('user_posts_page_id') ?>" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<fieldset><?php /*echo ga_template_tag();
								...
								// Swap wp_dropdown_categories for str_replace
								$select_cats = str_replace("name='cat' id=", "name='blt_post_category[]' multiple='multiple' id='blt_post_category'", $select_cats);
								echo $select_cats;*/
							...
							wp_list_categories(array(
  								...
  								'orderby' => 'NAME',
  								'id' => 'blt_post_category',
  								'name'     => 'blt_post_category', // name of the input
  								'selected' => (isset($_POST['blt_post_category']) ? $_POST['blt_post_category'] : ''), // checked items (category IDs)
							));*/
							?>
							</fieldset>
						</div>

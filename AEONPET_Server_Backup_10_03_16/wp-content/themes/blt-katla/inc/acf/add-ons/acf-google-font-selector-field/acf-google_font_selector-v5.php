...
class acf_field_google_font_selector extends acf_field {
	...
	*/
	function render_field( $field ) {
		...
		*/
		...
		<div class="acfgfs-form-control acfgfs-font-variants"><br>
				<div class="acfgfs-form-control-title"><strong><?php _e('Variants', 'acf-google_font_selector') ?></strong></div>
				<hr>
		...
		<div class="acfgfs-form-control acfgfs-font-subsets"><br>
			<div class="acfgfs-form-control-title"><strong><?php _e('Subsets', 'acf-google_font_selector') ?></strong></div>
			<hr>
			<div class="acfgfs-list">
			...
			<textarea type="hidden" name="acfgfs-font-data" class="acfgfs-font-data"><?php echo json_encode( $field ) ?></textarea>
	...
	*/
	function input_admin_enqueue_scripts() {
		...
		$dir = get_template_directory_uri() . '/inc/acf/add-ons/acf-google-font-selector-field/';

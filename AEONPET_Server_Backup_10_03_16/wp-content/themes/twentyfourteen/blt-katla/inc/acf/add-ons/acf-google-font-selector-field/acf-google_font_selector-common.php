    ...
    */
	...
	function display_variant_list( $variants = array(), $field ) {
		...
		foreach( $variants as $variant ) :
			...
			<div class="label-group"><input <?php echo $checked ?> type="checkbox" id="<?php echo $field['key'] ?>_variants_<?php echo $i ?>" name="<?php echo $field['key'] ?>_variants[]" value="<?php echo $variant ?>"><label for="<?php echo $field['key'] ?>_variants_<?php echo $i ?>"><?php echo $variant ?></label></div> 
	...
	function display_subset_list( $subsets = array(), $field ) {
		...
		foreach( $subsets as $subset ) :
			...
			?>
			<div class="label-group"><input <?php echo $checked ?> type="checkbox" id="<?php echo $field['key'] ?>_subsets_<?php echo $i ?>" name="<?php echo $field['key'] ?>_subsets[]" value="<?php echo $subset ?>"><label for="<?php echo $field['key'] ?>_subsets_<?php echo $i ?>"><?php echo $subset ?></label> </div>

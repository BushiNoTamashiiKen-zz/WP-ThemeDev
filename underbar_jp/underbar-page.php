			...
			<div class="section-banner flex-horizontal">
				...
				<div class="section-about-content flex-vertical">
					...
					<?php if (have_posts()): while (have_posts()) : the_post(); ?>
						...
						<?php if(is_user_logged_in()) {?>
							...
							<div class="start-btn flex-box">
								<a class="green_button" href="<?php echo home_url('/wp-admin/index.php/'); ?>"><i class="fa fa-calendar-plus-o" aria-hidden="true"></i>New Event</a>
							</div>
						<?php } else {?>

							<div class="start-btn flex-box">
								<a class="green_button" id="show_signup" href=""><i class="fa fa-calendar-plus-o" aria-hidden="true"></i>Start an event</a>
							</div>
						<?php } ?>
					...
					<?php else: ?>
						...
						<!-- /article -->
						https://www.youtube.com/watch?v=Tl8diKLgkhU
					<?php endif; ?>
				</div>
			</div>

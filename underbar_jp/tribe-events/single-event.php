...
<header class="section-head">	
	...
	<div class="left-btn-area">
		...
		<ul class="tribe-events-sub-nav">
			<li class="tribe-events-nav-previous">
				<?php tribe_the_prev_event_link( '<span>Previous</span>' ) ?>
			</li>
			<li class="tribe-events-nav-next"><?php tribe_the_next_event_link( '<span>Next</span>' ) ?>
			</li>
		</ul>
	</div>
	...
	<div class="right-btn-area">
		<a class="green_button" href="<?php echo esc_url( tribe_get_events_link() ); ?>"> 
			<i class="fa fa-calendar" aria-hidden="true"></i><?php printf( esc_html__( 'All Events', 'the-events-calendar' ), $events_label_plural ); ?>
		</a>
	</div>
</header>

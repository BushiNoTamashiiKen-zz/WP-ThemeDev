...
* Fixed a bug causing duplicate posts display.

= 2.8 =

* Introduced bogo_duplicate_post() and bogo_duplicate_post filter.
* Added REST-API endpoints.
* Changed UI in Languages meta-box.

= 2.7 =

* Localization for get_pages().
* Fixed: Language switcher was showing links to unpublished posts.
* New: bogo_use_implicit_lang filter hook.

...
<div class="post-info-container">
	...
	<div class="tribe-events-event-meta">
		...
		<footer class="flex-horizontal post-footer-meta">
			<span class="event-date">いつ: <a id="active-link" href=""><?php echo tribe_events_event_schedule_details(); ?></a></span>
			<span class="author"><?php _e( '作った人は:', 'html5blank' ); ?><?php the_author_posts_link(); ?><i class="fa fa-user" aria-hidden="true"></i></span>
		</footer>
	...
	<div class="tribe-events-list-event-description tribe-events-content">
		...
		<a href="<?php echo esc_url( tribe_get_event_link() ); ?>" class="tribe-events-read-more" rel="bookmark"><?php esc_html_e( '詳しくに読む', 'the-events-calendar' ) ?> &raquo;</a>

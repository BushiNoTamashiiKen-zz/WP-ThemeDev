	...
	<main role="main" class="flex-lrg">
		...
		<header class="section-head">
			...
			<p><?php if(is_user_logged_in()) {
				...
				echo 'こんにちは'.' '.$user->display_name;
			} else {

			  	_e( 'アンダバーイベント', 'Underbar' );
			}?>
			</p>
			<div class="right-btn-area">
				<?php if(!is_user_logged_in()) {?>

					<a class="signup_button" id="show_signup" href=""><i class="fa fa-calendar-plus-o" aria-hidden="true"></i>イベントを始める</a>
				<?php } else { ?>

					<span><a class="green_button" href="<?php echo home_url('/event/'); ?>"><i class="fa fa-calendar-o" aria-hidden="true"></i>カレンダー</a></span>
				<?php } ?>
			</div>
		</header>
		<!-- /Header -->

...
<?php get_sidebar(); ?>
	...
	<main role="main" class="flex-lrg post-listing">
		...
		<header class="section-head">
			...
			<div class="right-btn-area">
				...
				<?php } else { ?>
					...
					<span><a class="green_button" href="<?php echo home_url('/wp-admin/edit.php?post_type=tribe_events'); ?>"><i class="fa fa-calendar-o" aria-hidden="true"></i>Add New Event</a></span>
				<?php } ?>
			</div>
		</header>
		<!-- /Header -->
		...
		<section id="content" class="content-area">
			...
			<?php //get_template_part('ajax-event-loop'); ?>

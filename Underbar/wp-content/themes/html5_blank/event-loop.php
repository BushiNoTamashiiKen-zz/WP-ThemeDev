...
<?php if (have_posts()) {
	...
	foreach ( $events as $post ) {
		...
		<section id="content" class="post-block">
			<!-- article -->
			<article class="" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="post-info-container">
					...
					<span class="comments">Comments: <?php if (comments_open( get_the_ID() ) ) comments_popup_link( __( 'Leave your thoughts', 'html5blank' ), __( '1 Comment', 'html5blank' ), __( '% Comments', 'html5blank' )); ?></span>
					<!-- Footer Post Meta -->
...
<?php } else { ?>
	...
	<article class="no-content">
		...
		<h2><?php _e( 'Sorry, no more events to display.', 'html5blank' ); ?></h2>
	</article>
	<!-- /article -->
